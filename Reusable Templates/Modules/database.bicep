...
@description('The name of the environment. Prod or Dev.')
@allowed([
  'Prod'
  'Dev'
])
...
var sqlServerName = 'ecomm${location}${uniqueString(resourceGroup().id)}'
var sqlDatabaseName = 'ecommerce'
var auditingEnabled = environmentName == 'Prod'
var auditStorageAccountName = take('ordersaudit${location}${uniqueString(resourceGroup().id)}', 24)
